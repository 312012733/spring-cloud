...
public class ResponseErrorHandler implements org.springframework.web.client.ResponseErrorHandler
{
     ...
     * <p>
     * The default implementation checks if the given status code is {@link HttpStatus.Series#CLIENT_ERROR CLIENT_ERROR}
     * or {@link HttpStatus.Series#SERVER_ERROR SERVER_ERROR}. Can be overridden in subclasses.
     *
     * @param statusCode
    ...
    /**
     * This default implementation throws a {@link HttpClientErrorException} if the response status code is
     * {@link HttpStatus.Series#CLIENT_ERROR}, a {@link HttpServerErrorException} if it is
     * {@link HttpStatus.Series#SERVER_ERROR}, and a {@link RestClientException} in other cases.
     */
    @Override
