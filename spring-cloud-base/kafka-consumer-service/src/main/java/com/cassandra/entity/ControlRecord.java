...
public class ControlRecord
{
     ...
     * 11：关闭空气净化器；12：远程启动；16：远程熄火；17：座椅温度控制(附加项16、17)；18：座椅通风控制(附加项18、19)； 19：天窗控制； 999：sendToCar
     */
    @Column(value = "action")
     ...
     * 8：空调压缩机远程控制；9：前空调内外循环远程控制；10： 前除霜远程控制；11：前空调副驾温度远程控制；12：前空调主驾温度远程控制；13：前空调开关远程；
    ...
    /**
     * 1.双侧温度调节：1:增加+0.5,2:,降低-0.5； 2.前空调模式远程：1:吹面,2:吹面除霜,3:吹脚,4:吹脚除霜； 3.双侧温度设置：17.5-32.5(调用者*10,传入整数)；
     * 4.后空调开关：1:关,2:开；5.前空调副驾温度：1:增加+0.5,2:,降低-0.5； 6.前空调主驾温度：1:增加+0.5,2:,降低-0.5； 7.前空调风量高低：1:增加+1,2:降低-1；
     * 8.空调压缩机远程控制：1：关闭,2：打开；9.前空调内外循环：1:请求内循环,2:请求外循环； 10.前除霜远程控制：1：关闭,2：开启；
     * 11.前空调副驾驶温度：17.5-32.5(调用者*10,传入整数)；12.前空调主驾驶温度：17.5-32.5(调用者*10,传入整数)； 13.前空调开关：1:关,2:开；
     * 14.前空调风量控制：1-7：1档-7档；15.空气净化器工作模式：0:自动,1:低,2:中,3:高,9999:只开启；16.左前座椅加热请求：1:关,2:低,3:中,4:高；
     * 17.右前座椅加热请求：1:关,2:低,3:中,4:高；18.左前座椅通风请求：1:关,2:低,3:中,4:高； 19.右前座椅通风请求：1:关,2:低,3:中,4:高； 20.天窗控制请求：1:开,2:关；
     */
