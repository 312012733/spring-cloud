...
// @ConditionalOnProperty(matchIfMissing = false, prefix =
// "kafka.consumerProperties", name =
// { "bootstrap.servers" })
...
// {
// KafkaUtils.createTopics(kafkaBean.getTopics(),
// kafkaBean.getZookeeper().getConnect());
// }
//
// private static class MyConsumerAwareRebalanceListener implements
...
// {
// MyConsumerRebalanceListener myConsumerRebalanceListener = new
// MyConsumerRebalanceListener(consumer);
